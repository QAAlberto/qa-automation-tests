...
public class PrayerWarriorNetworkBillingList extends BaseTest {
    @BeforeClass
    @Parameters("language")
    public void beforeClass(String language){
        PropertyManager propertyManager = new PropertyManager();
        ExtentTest extentTest = extent.createTest("prayer_warrior_network_billing List");
        test.set(extentTest);
        lang = language;
